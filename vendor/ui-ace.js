...
angular.module('ui.ace', [])
  ...
  .directive('uiAce', ['uiAceConfig', function (uiAceConfig) {
    ...
    var setOptions = function (acee, session, opts) {
      ...
      // Added support for path options wiz-2994
      angular.forEach(['basePath', 'modePath', 'workerPath'], function (opt) {
        if (angular.isString(opts[opt])) {
          window.ace.config.set(opt, opts[opt]);
        }
      });
